...
var CameraViewController = UIViewController.extend({
    ...
    createControls: function () {
        ...
        // Add iso dial
        // Current max iso value is 460
        this.iso = DialSelector.alloc().initWithOptions({
            frame: CGRectMake(110, 150, 320, 320),
            text: "ISO",
            views: this.createLabels(["32", "64", "128", "256", "400"]),
            values: [32, 64, 128, 256, 400]
        });
    ...
    updateCamera: function () {
        if (UIDevice.currentDevice.systemVersion.split(".")[0] >= 8) {
